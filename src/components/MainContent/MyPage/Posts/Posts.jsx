...
const Posts = (props) => {
    ...
    let post = props.dataPost
        .map(post => <Post avatar={post.avatar} name={post.name} time={post.time}
                           img={post.img}
                           text={post.text}
    ...
    return(
        <div className={PostsSass.posts}>
            <div className={PostsSass.create}>
                <div className={PostsSass.photo}>
                ...
                <div className={PostsSass.text}>
                    <input value={props.newPostText} onChange={onPostChange} ref={createPostElement} type="text" placeholder="Добавьте что нибудь" />
                    <button onClick={onCreatePost}>Добавить</button>
                </div>
            </div>
